...
**Top left**: "Source" window. This is where you type your text and code and save it as an R markdown file (like this one), so you can run it as many times as you like.

**Top right**: "Environment" window. This shows you the list of all the data you have currently available.
...
To knit to pdf, you need to have LaTeX installed on your computer. If you don't already have it, you can install the tinytex package: install.packages("tinytex") After that you'll need to restart Rstudio and run: tinytex::install_tinytex()
